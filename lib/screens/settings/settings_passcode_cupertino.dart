  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SettingsPasscodeCubit, SettingsPasscodeState>(
      listenWhen: (previousState, currentState) => !listEquals(previousState.passcode, currentState.passcode) ||
          previousState.isBiometric != currentState.isBiometric || previousState.autoLockSeconds != currentState.autoLockSeconds,
                    ...
                    CupertinoListSection.insetGrouped(
                      children: [
                        CupertinoListTile(
                          ...
                          onTap: () async => context.read<CommonCubit>().forceLock(),
                        ),
                      ],
                    ),
                  ]
