              ...
              children: [
                  ...
                  children: [
                    CupertinoListTile(
                      ...
                      leading: Container(
                        ...
                        child: Center(
                          child: FaIcon(currentSession.os == 1 ? FontAwesomeIcons.apple : FontAwesomeIcons.android, size: 18, color: Color(0xFFFFFFFF)),
                        ),
                      ),
                      title: Column(
                        spacing: 4,
                ...
                if (state.deviceSessions.any((data) => data.isCurrent == false))
                  CupertinoListSection.insetGrouped(
                    ...
                    children: [
                    for (final deviceSession in (state.deviceSessions.where((data) => data.isCurrent == false).toList()..sort((a, b) => b.updateAt.compareTo(a.updateAt)))) ... [
                      Slidable(
                        ...
                        endActionPane: ActionPane(
                          ...
                          dismissible: DismissiblePane(
                            ...
                            onDismissed: () async => await context.read<SettingsDeviceSessionsCubit>().terminate([deviceSession.sessionID]),
                          ),
                          children: [
                        ...
                        child: CupertinoListTile(
                          ...
                          subtitle: Text(context.t.settings.deviceSessionListTileSubtitle(
