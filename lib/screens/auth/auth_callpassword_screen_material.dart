...
class AuthCallPasswordMaterialScreen extends StatefulWidget {
  ...
  const AuthCallPasswordMaterialScreen({
    super.key,
  ...
  @override
  State<AuthCallPasswordMaterialScreen> createState() => _AuthCallPasswordMaterialScreen();
}

class _AuthCallPasswordMaterialScreen extends State<AuthCallPasswordMaterialScreen> with WidgetsBindingObserver, SingleTickerProviderStateMixin {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async => utils.makePhoneCall(widget.confirmationPhoneNumber),
