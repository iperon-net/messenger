...
mixin _$SettingsDevice implements DiagnosticableTreeMixin {
 ...
 String get language; SettingsDeviceDarkMode get darkMode; SettingsDeviceThemeColor get themeColor; String get passCode; int get passCodeTtl; int get passCodeTimer; int get viewTaskSwitchingEnable;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,language,darkMode,themeColor,passCode,passCodeTtl,passCodeTimer,viewTaskSwitchingEnable);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'SettingsDevice(language: $language, darkMode: $darkMode, themeColor: $themeColor, passCode: $passCode, passCodeTtl: $passCodeTtl, passCodeTimer: $passCodeTimer, viewTaskSwitchingEnable: $viewTaskSwitchingEnable)';
}
...
@useResult
$Res call({
 String language, SettingsDeviceDarkMode darkMode, SettingsDeviceThemeColor themeColor, String passCode, int passCodeTtl, int passCodeTimer, int viewTaskSwitchingEnable
});
...
/// Create a copy of SettingsDevice
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? language = null,Object? darkMode = null,Object? themeColor = null,Object? passCode = null,Object? passCodeTtl = null,Object? passCodeTimer = null,Object? viewTaskSwitchingEnable = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String language,  SettingsDeviceDarkMode darkMode,  SettingsDeviceThemeColor themeColor,  String passCode,  int passCodeTtl,  int passCodeTimer,  int viewTaskSwitchingEnable)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsDevice() when $default != null:
return $default(_that.language,_that.darkMode,_that.themeColor,_that.passCode,_that.passCodeTtl,_that.passCodeTimer,_that.viewTaskSwitchingEnable);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String language,  SettingsDeviceDarkMode darkMode,  SettingsDeviceThemeColor themeColor,  String passCode,  int passCodeTtl,  int passCodeTimer,  int viewTaskSwitchingEnable)  $default,) {final _that = this;
switch (_that) {
case _SettingsDevice():
return $default(_that.language,_that.darkMode,_that.themeColor,_that.passCode,_that.passCodeTtl,_that.passCodeTimer,_that.viewTaskSwitchingEnable);case _:
  throw StateError('Unexpected subclass');
...
class _SettingsDevice extends SettingsDevice with DiagnosticableTreeMixin {
  const _SettingsDevice({required this.language, required this.darkMode, required this.themeColor, required this.passCode, required this.passCodeTtl, required this.passCodeTimer, required this.viewTaskSwitchingEnable}): super._();
...
/// Create a copy of SettingsDevice
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? language = null,Object? darkMode = null,Object? themeColor = null,Object? passCode = null,Object? passCodeTtl = null,Object? passCodeTimer = null,Object? viewTaskSwitchingEnable = null,}) {
