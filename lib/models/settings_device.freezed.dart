...
mixin _$SettingsDevice implements DiagnosticableTreeMixin {
 ...
 String get language; SettingsDeviceDarkMode get darkMode; SettingsDeviceThemeColor get themeColor; int get blurTaskSwitchingEnable;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('language', language))..add(DiagnosticsProperty('darkMode', darkMode))..add(DiagnosticsProperty('themeColor', themeColor))..add(DiagnosticsProperty('blurTaskSwitchingEnable', blurTaskSwitchingEnable));
}
...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'SettingsDevice(language: $language, darkMode: $darkMode, themeColor: $themeColor, blurTaskSwitchingEnable: $blurTaskSwitchingEnable)';
}
...
@useResult
$Res call({
 String language, SettingsDeviceDarkMode darkMode, SettingsDeviceThemeColor themeColor, int blurTaskSwitchingEnable
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String language,  SettingsDeviceDarkMode darkMode,  SettingsDeviceThemeColor themeColor,  int blurTaskSwitchingEnable)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsDevice() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String language,  SettingsDeviceDarkMode darkMode,  SettingsDeviceThemeColor themeColor,  int blurTaskSwitchingEnable)  $default,) {final _that = this;
switch (_that) {
case _SettingsDevice():
return $default(_that.language,_that.darkMode,_that.themeColor,_that.blurTaskSwitchingEnable);case _:
  throw StateError('Unexpected subclass');
...
class _SettingsDevice extends SettingsDevice with DiagnosticableTreeMixin {
  const _SettingsDevice({required this.language, required this.darkMode, required this.themeColor, required this.blurTaskSwitchingEnable}): super._();
...
@override final  int blurTaskSwitchingEnable;
