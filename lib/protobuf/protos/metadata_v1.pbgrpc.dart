...
class MetadataClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.MetadataGeoIPResponse> geoIP(
    $0.MetadataGeoIPRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$geoIP =
      $grpc.ClientMethod<$0.MetadataGeoIPRequest, $0.MetadataGeoIPResponse>(
          '/iperon.v1.Metadata/GeoIP',
          ($0.MetadataGeoIPRequest value) => value.writeToBuffer(),
          $0.MetadataGeoIPResponse.fromBuffer);
}
...
abstract class MetadataServiceBase extends $grpc.Service {
  ...
  MetadataServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.MetadataGeoIPRequest, $0.MetadataGeoIPResponse>(
            'GeoIP',
            geoIP_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.MetadataGeoIPRequest.fromBuffer(value),
            ($0.MetadataGeoIPResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.MetadataGeoIPResponse> geoIP_Pre($grpc.ServiceCall $call,
      $async.Future<$0.MetadataGeoIPRequest> $request) async {
    return geoIP($call, await $request);
  }

  $async.Future<$0.MetadataGeoIPResponse> geoIP(
      $grpc.ServiceCall call, $0.MetadataGeoIPRequest request);
}
