...
final $typed_data.Uint8List authCallPasswordDescriptor = $convert.base64Decode(
    'ChBBdXRoQ2FsbFBhc3N3b3JkGisKB1JlcXVlc3QSIAoLcGhvbmVOdW1iZXIYASABKAlSC3Bob2'
...
const AuthCallPasswordConfirmation$json = {
  ...
  '3': [
    AuthCallPasswordConfirmation_Request$json,
    AuthCallPasswordConfirmation_Response$json
  ],
};
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.iperon.v1.AuthCallPasswordStatus',
      '10': 'authCallPasswordStatus'
    },
...
final $typed_data.Uint8List authCallPasswordConfirmationDescriptor = $convert.base64Decode(
    'ChxBdXRoQ2FsbFBhc3N3b3JkQ29uZmlybWF0aW9uGjsKB1JlcXVlc3QSMAoTY2FsbFBhc3N3b3'
...
const AuthModerationApplicationStore$json = {
  ...
  '3': [
    AuthModerationApplicationStore_Request$json,
    AuthModerationApplicationStore_Response$json
  ],
};
...
const AuthModerationApplicationStore_Response$json = {
  ...
  '2': [
    {
      '1': 'moderationApplicationStoreSession',
      '3': 1,
      '4': 1,
      '5': 12,
      '10': 'moderationApplicationStoreSession'
    },
...
final $typed_data.Uint8List authModerationApplicationStoreDescriptor =
    $convert.base64Decode(
        'Ch5BdXRoTW9kZXJhdGlvbkFwcGxpY2F0aW9uU3RvcmUaKwoHUmVxdWVzdBIgCgtwaG9uZU51bW'
...
@$core.Deprecated(
    'Use authModerationApplicationStoreConfirmationDescriptor instead')
const AuthModerationApplicationStoreConfirmation$json = {
  '1': 'AuthModerationApplicationStoreConfirmation',
  '3': [
    AuthModerationApplicationStoreConfirmation_Request$json,
    AuthModerationApplicationStoreConfirmation_Response$json
  ],
};
...
final $typed_data.Uint8List
    authModerationApplicationStoreConfirmationDescriptor =
    $convert.base64Decode(
        'CipBdXRoTW9kZXJhdGlvbkFwcGxpY2F0aW9uU3RvcmVDb25maXJtYXRpb24agwEKB1JlcXVlc3'
...
const AuthConfirmation_Request$json = {
  ...
  '2': [
    ...
    {
      '1': 'publicKeySharedKey',
      '3': 2,
      '4': 1,
      '5': 12,
      '10': 'publicKeySharedKey'
    },
...
final $typed_data.Uint8List authConfirmationDescriptor = $convert.base64Decode(
    'ChBBdXRoQ29uZmlybWF0aW9uGqkCCgdSZXF1ZXN0EjAKE2NvbmZpcm1hdGlvblNlc3Npb24YAS'
