...
class Logout_Response extends $pb.GeneratedMessage {
  ...
  factory Logout_Response.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Logout_Response.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Logout.Response',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'iperon.v1'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  Logout_Response copyWith(void Function(Logout_Response) updates) =>
      super.copyWith((message) => updates(message as Logout_Response))
          as Logout_Response;
  ...
  @$core.pragma('dart2js:noInline')
  static Logout_Response getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Logout_Response>(create);
