...
class ThemesCupertino {
  ...
  /// осветления). За счёт того, что берётся `primaryColor`, фон меняется вместе
  /// с выбранным оформлением (синий/зелёный/фиолетовый/оранжевый). По духу — как
  /// [screenLockBackground], но собственный для экрана звонка.
